# Jay
The original source code is from **Hibernate Download**: https://sourceforge.net/projects/hibernate/files/hibernate-orm/, unzip it, workspace/hibernate-release-5.6.5.Final/project
...
The other hibernate source code is here: https://github.com/JayZhou-1/hibernate-tutorials:  workspace/hibernate-release-5.6.5.Final/documentation/quickstart/html_single/hibernate-tutorials
